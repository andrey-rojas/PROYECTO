...
<?php
    ...
    ?>
            ...
            <section class="contenedor nuestro-producto"><a id="destino"></a>
                <h2 class="titulo2">Gorros Y Bufandas</h2>
                <div class="contenedor-nuestro-producto">
                    <img src="img/atu7.jpeg" alt="" >
                    <div class="parrafo-textos">
                        <h3><span></span>En Esta Seccion...</h3>
                        <p> Encontraras lo mejor en Gorros Y Bufandas para dama y caballero,
    ...
    <main>
        <?php
            $response = json_decode(file_get_contents('http://localhost/atumedida/categorias/gorros/carrito/api/productos/api-productos.php?categoria=gorros'), true);

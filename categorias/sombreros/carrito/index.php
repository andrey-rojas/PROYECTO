...
<?php
    ...
    ?>
            ...
            <section class="contenedor nuestro-producto"><a id="destino"></a>
                <h2 class="titulo2">Sombreros</h2>
                <div class="contenedor-nuestro-producto">
                    <img src="img/atu9.jpeg" alt="" >
                    <div class="parrafo-textos">
                        <h3><span></span>En Esta Seccion...</h3>
                        <p> Encontraras lo mejor en Sombreros para dama y caballero,
    ...
    <main>
        <?php
            $response = json_decode(file_get_contents('http://localhost/atumedida/categorias/sombreros/carrito/api/productos/api-productos.php?categoria=sombreros'), true);

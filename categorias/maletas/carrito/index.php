...
<head>
    ...
    <title>Maletas Y Morrales</title>
...
<?php
    ...
    ?>
            ...
            <section class="contenedor nuestro-producto"><a id="destino"></a>
                <h2 class="titulo2">Maletas Y Morrales</h2>
                <div class="contenedor-nuestro-producto">
                    <img src="img/atu1.jpeg" alt="" >
                    <div class="parrafo-textos">
                        <h3><span></span>En Esta Seccion...</h3>
                        <p> Encontraras lo mejor en Maletas Y Morrales para dama y caballero,
    ...
    <main>
        <?php
            $response = json_decode(file_get_contents('http://localhost/atumedida/categorias/maletas/carrito/api/productos/api-productos.php?categoria=maletas'), true);

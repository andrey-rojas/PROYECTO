...
<head>
    ...
    <title>Cinturones Y Carteras</title>
...
<?php
    ...
    ?>
            ...
            <section class="contenedor nuestro-producto"><a id="destino"></a>
                <h2 class="titulo2">Cinturones Y Carteras</h2>
                <div class="contenedor-nuestro-producto">
                    <img src="img/atu4.jpeg" alt="" >
                    <div class="parrafo-textos">
                        <h3><span></span>En Esta Seccion...</h3>
                        <p> Encontraras lo mejor en Cinturones Y Carteras para dama y caballero,
                            tenemos una gran varidad, parq ue todo sea a tu medida... </p><br>
    ...
    <main>
        <?php
            $response = json_decode(file_get_contents('http://localhost/atumedida/categorias/cinturones/carrito/api/productos/api-productos.php?categoria=cinturones'), true);

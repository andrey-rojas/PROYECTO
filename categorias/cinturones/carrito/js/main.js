...
function actualizarCarritoUI(){
    fetch('http://localhost/atumedida/categorias/cinturones/carrito/api/carrito/api-carrito.php?action=mostrar')
    .then(response =>{
    ...
    .then(data =>{
        ...
        data.items.forEach(element => {
            html += `
                <div class='fila'>
                    <div class='imagen'><img src='img/${element.imagen}' width='60' /></div>
                    <div class='info'>
...
const addItemToCarrito = id =>{
    fetch('http://localhost/atumedida/categorias/cinturones/carrito/api/carrito/api-carrito.php?action=add&id=' + id)
    .then(response =>{
...
const removeItemFromCarrito = id =>{
    fetch('http://localhost/atumedida/categorias/cinturones/carrito/api/carrito/api-carrito.php?action=remove&id=' + id)
    .then(res =>{
        return res.json();
    })
    .then(data =>{

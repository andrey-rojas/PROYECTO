...
<head>
    ...
    <title>Zapatos Y Zapatillas</title>
...
<?php
    ...
    ?>
            ...
            <section class="contenedor nuestro-producto"><a id="destino"></a>
                <h2 class="titulo2">Zapatos Y Zapatillas</h2>
                <div class="contenedor-nuestro-producto">
                    <img src="img/icono_muestra.jpeg" alt="" >
                    <div class="parrafo-textos">
                        <h3><span></span>En Esta Seccion...</h3>
                        <p> Encontraras lo mejor en Zapatos Y Zapatillas para dama y caballero,
    ...
    <main>
        <?php
            $response = json_decode(file_get_contents('http://localhost/atumedida/categorias/zapatos/carrito/api/productos/api-productos.php?categoria=zapatos'), true);

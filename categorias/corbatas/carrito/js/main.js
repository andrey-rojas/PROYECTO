...
function actualizarCarritoUI(){
    fetch('http://localhost/atumedida/categorias/corbatas/carrito/api/carrito/api-carrito.php?action=mostrar')
    .then(response =>{
...
const addItemToCarrito = id =>{
    fetch('http://localhost/atumedida/categorias/corbatas/carrito/api/carrito/api-carrito.php?action=add&id=' + id)
    .then(response =>{
...
const removeItemFromCarrito = id =>{
    fetch('http://localhost/atumedida/categorias/corbatas/carrito/api/carrito/api-carrito.php?action=remove&id=' + id)
    .then(res =>{
        return res.json();
    })
    .then(data =>{
